...
- public (*boolean*) - Se il post deve essere pubblico (*true*) o una bozza (*false*) <br>

L’endpoint a cui effettuare la chiamata POST è il seguente: <br>
https://67c5b4f3351c081993fb1ab6.mockapi.io/api/posts <br>
